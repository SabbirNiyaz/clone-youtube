...
// Object { category_id: "1001", category: "Music" }
// category: "Music"
// category_id: "1001"

// create displayCategories buttons
const displayCategories = (categories) => {
        ...
        class="btn category-btn rounded-sm">
          ${item.category}
        </button>
        `
...
const displayDetails = (video) => {
  ...
  <p class="px-2 pt-2">${video.description}</p>
  `
  // way-1
...
const displayVideos = (videos) => {
        ...
        if(videos.length == 0){
          ...
          videosContainer.innerHTML = `
          <div class="min-h-[600px] flex flex-col gap-5 justify-center
          items-center">
